...
- [Session 1 - IaC and Terraform Intro](./session-1_iac-and-terraform-intro/README.md)
- [Session 2 - Terraform Basics](./session-2_terraform-basics/README.md)
- [Session 3 - Terraform State](./session-3_terraform-state/README.md)
- [Session 4 - Terraform Tips n Tricks](./session-4_terraform-tips-n-tricks/README.md)
- [Session 5 - Terraform Modules](./session-5_terraform-modules/README.md)
- [Session 6 - Terraform Cloud and Pipelines](./session-6_terraform_cloud_and_pipelines/README.md)
...
Request AWS Beach Access in okta.
