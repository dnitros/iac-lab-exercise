...
If you don't understand or need to brush up on AWS VPCs and networking before starting this lab exercise then I would recommend checking some youtube videos.  This should help you understand the basics around VPCs, networking and routing.
